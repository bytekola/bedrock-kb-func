...
api.defaults.headers.common["access-control-allow-methods"] = "DELETE,GET,HEAD,OPTIONS,PATCH,POST,PUT"
api.defaults.headers.common["access-control-max-age"] = "864000"
