import { BedrockFoundationModel, IKnowledgeBase, KnowledgeBase } from "@cdklabs/generative-ai-cdk-constructs/lib/cdk-lib/bedrock";
...
import { VectorCollection, VectorCollectionStandbyReplicas } from "@cdklabs/generative-ai-cdk-constructs/lib/cdk-lib/opensearchserverless";
import { aws_bedrock as bedrock, CfnOutput, Stack, StackProps } from "aws-cdk-lib";
...
export class BedrockCustomBotStack extends Stack {
  constructor(scope: Construct, id: string, props: BedrockCustomBotStackProps) {
    ...
    if (props.existKnowledgeBaseId == undefined) {
      console.log("Start Creating Knowledge")
      console.log("---------------- vectorCollection ----------------")
      ...
      console.log(vectorCollection.node.children)
